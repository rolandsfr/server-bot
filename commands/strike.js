...
module.exports = {
	...
	async execute(msg, args, Discord, bot) {
		...
		if(!args[0]) return msg.reply("Please, specify argument - either `vouch`, `close` or tag a member to use certain functionality of this command. Refer to #bot-info for more details.")
